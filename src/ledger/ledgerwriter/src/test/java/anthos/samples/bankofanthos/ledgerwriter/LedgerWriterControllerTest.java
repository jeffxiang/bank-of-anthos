...
class LedgerWriterControllerTest {
    ...
    private static final String RECIPIENT_ACCOUNT_NUM = "2222222222";
    private static final String SCREENED_ACCOUNT_NUM = "3333333333";
    ...
    void addTransactionFailWhenSenderNotAuthedAccount(TestInfo testInfo) {
        ...
        stubTransaction(OTHER_ACCOUNT_NUM, LOCAL_ROUTING_NUM,
                RECIPIENT_ACCOUNT_NUM, LOCAL_ROUTING_NUM,
                SMALLER_THAN_SENDER_BALANCE, testInfo);
    ...
    void addTransactionFailWhenRoutingNumberInvalid(TestInfo testInfo) {
        ...
        when(claim.asString()).thenReturn(AUTHED_ACCOUNT_NUM);
        stubTransaction(AUTHED_ACCOUNT_NUM, LOCAL_ROUTING_NUM,
                RECIPIENT_ACCOUNT_NUM, INVALID_ROUTING_NUM,
                SMALLER_THAN_SENDER_BALANCE, testInfo);
    ...
    @Test
    @DisplayName("Given the sender balance cannot cover an internal transaction, " +
            "write nothing to the ledger")
    void addTransactionWritesNothingWhenBalanceInsufficient(TestInfo testInfo) {
        // Given
        LedgerWriterController spyLedgerWriterController =
                spy(ledgerWriterController);
        when(transaction.getFromRoutingNum()).thenReturn(LOCAL_ROUTING_NUM);
