...
class BalanceReaderControllerTest {
    ...
    @Test
    @DisplayName("Given a malformed token with no Bearer prefix, return 401 without reading the cache")
    ...
    void getBalanceFailsWhenCacheLoaderThrowsUncheckedException() throws Exception {
        ...
        when(cache.get(AUTHED_ACCOUNT_NUM)).thenThrow(
            new UncheckedExecutionException(new DataAccessResourceFailureException("ledger down")));
