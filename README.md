...
| [ui-angular](/src/ui-angular)                          | TypeScript    | Angular 14 single-page frontend with the same login, signup, account, contacts, payment, and deposit workflows as the Flask frontend.       |
